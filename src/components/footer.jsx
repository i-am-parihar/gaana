  ...
  return (
    <div className='mainBox'>
      ...
      <div style={{alignItems:'center'}}>
        <img  className='icon' style={{marginLeft: '50%'}} src='https://cdn-icons.flaticon.com/png/512/3670/premium/3670032.png?token=exp=1648733409~hmac=6e03b4e1ae17fb4af7aac303554314fc'/>
